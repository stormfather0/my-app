...
<div className="relative flex-1 min-w-0 " ref={dropdownRef}>
  <form
    ...
    className="flex bg-white rounded-lg shadow-sm overflow-hidden w-full focus:outline-none focus:ring-2 "
  >
    <input
      type="search"
...
{voicePopup && (
  <div className="fixed inset-0 flex items-center justify-center z-50">
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-2xl w-80 max-w-sm text-center flex flex-col items-center">
      <p className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">
        Voice Search
      </p>
      <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
        Speak now to search for products quickly.
      </p>
    ...
    <button
      type="submit"
      className="hidden sm:flex bg-green-600 hover:bg-green-700 px-4 py-2 rounded-lg text-white items-center justify-center cursor-pointer"
    >
