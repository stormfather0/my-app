...
const categories = [
  ...
  {
    label: "Laptops and PC",
    icon: "https://img.icons8.com/ios-filled/50/computer.png",
  },
  {
    label: "Smartphones & TVs",
    icon: "https://img.icons8.com/ios-filled/50/smartphone.png",
  },
  {
    label: "For Gamers",
    icon: "https://img.icons8.com/ios-filled/50/controller.png",
  },
  {
    label: "Tools",
    icon: "https://img.icons8.com/ios-filled/50/000000/maintenance.png",
  },
  {
    label: "Clothing",
    icon: "https://img.icons8.com/ios-filled/50/clothes.png",
  },
  { label: "Shoes", icon: "https://img.icons8.com/ios-filled/50/shoes.png" },
  {
    label: "Groceries",
    icon: "https://img.icons8.com/ios-filled/50/shopping-basket.png",
  },
  {
    label: "Baby Products",
    icon: "https://img.icons8.com/ios-filled/50/baby.png",
  },
  {
    label: "Special Sale",
    icon: "https://icons.iconarchive.com/icons/icons8/ios7/512/Ecommerce-Sale-icon.png",
  },
  ...
  if (isStatic) {
   ...
   ${
     item.label === "Chat With Us"
       ? " text-green-700 py-1 pl-10 font-semibold"
       : "pl-10"
   }
 `}
            >
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-gray-900   bg-opacity-50 z-50">
    <div className="bg-white p-6 rounded-lg shadow-lg w-200 h-50">
    <div className="flex justify-end">
    <button
      onClick={() => setChatWithUs(false)}
      className="absolute top-2 right-2 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 cursor-pointer"
    >
      X
    </button>
  </div>
      <h2 className="text-lg font-semibold mb-4">Chat with us</h2>
      <p className="text-sm text-gray-600 mb-2">How can we help you today?</p>
      <div className="flex items-center gap-2 w-full">
  <input
    type="text"
    placeholder="Type your message..."
    className="flex-grow border border-green-600 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
  />
  <button
    className="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-md transition-colors duration-300 cursor-pointer"
  >
    Send
  </button>
</div>
        ...
        <div className="p-4 mb-2">
          ...
          <div className="flex flex-col items-center justify-center gap-2 bg-gray-100 rounded p-3 my-4">
            <p className="text-md text-gray-500 text-center ">
              Subscribe and be the first to receive information about the start
              of sales, discounts, promotions, bonuses and welcome surprises at
              Website.com
            </p>
          ...
          <div className="flex flex-col justify-center my-2 border-t border-b border-gray-200">
            <p className="text-md text-gray-700 pt-4 pl-10">
              Download our apps :
            </p>
            <div className="flex items-center justify-center   gap-2 mb-2 pl-2">
              {" "}
              {/* reduced vertical spacing */}
              <a href="#">
                <img
                  className="w-28 h-15"
                  src="/my-app/applestore.png"
                  alt="App Store"
                />
              </a>
              <a href="#">
